...
# Define data folder
data_folder = os.path.join(drive, root_folder, 'GISdata/climatology/snowextent')
...
mean_raw = os.path.join(processed_folder, 'full/ABoVE_SnowExntentCycles_MeanWinter_Raw_1km_2001-2017.tif')
mean_interpolated = os.path.join(processed_folder, 'sa/ABoVE_SnowExtentCycles_MeanWinter_Interpolated_1km_2001-2017.tif')

# Define grids
grid_list = ['A1', 'A2', 'B1', 'B2']

# Define month and property values
climate_property = 'ABoVE_SnowExtentCycles'
years = ['2001_2017']
...
for grid in grid_list:
    ...
    output_raster = os.path.join(output_path, 'ABoVE_SnowExtent_MeanWinter_AKALB_' + grid + '.tif')
