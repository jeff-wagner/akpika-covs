...
# Author: Timm Nawrocki (edited by Jeff Wagner)
# Last Updated: 2021-01-04 (2022-07-12)
...
# Define data folder
data_folder = os.path.join(drive, root_folder, 'GISdata/climatology')

# Define input csv table
input_table = os.path.join(data_folder, 'ClimateDatasets_20220712.csv')
