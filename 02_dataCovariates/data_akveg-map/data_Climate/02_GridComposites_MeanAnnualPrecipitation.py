...
# Define data folder
data_folder = os.path.join(drive, root_folder, 'GISdata/climatology/precipitation')
...
mean_raw = os.path.join(processed_folder, 'full/Precipitation_MeanAnnual_Raw_2km_2000-2019.tif')
mean_interpolated = os.path.join(processed_folder, 'sa/Precipitation_MeanAnnual_Interpolated_2km_2000-2019.tif')

# Define grids
grid_list = ['A1', 'A2', 'B1', 'B2']

# Define month and property values
climate_property = 'pr_total_mm_CRU_TS405_historical'
