...
mean_raw = os.path.join(processed_folder, 'full/SummerWarmth_MeanAnnual_Raw_2km_2000-2019.tif')
mean_interpolated = os.path.join(processed_folder, 'sa/SummerWarmth_MeanAnnual_Interpolated_2km_2000-2019.tif')

# Define grids
grid_list = ['A1', 'A2', 'B1', 'B2']

# Define month and property values
climate_property = 'tas_mean_C_CRU_TS405_historical'
...
for grid in grid_list:
    ...
    output_raster = os.path.join(output_path, 'SummerWarmth_MeanAnnual_AKALB_' + grid + '.tif')
