# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Interpolate Raster 32-bit
# Author: Timm Nawrocki
# Last Updated: 2021-03-10
# Usage: Must be executed in an ArcGIS Pro Python 3.6 installation.
# Description: "Interpolate Raster 32-bit" is a function that interpolates a raster based on geographic nearest neighbors but retains 32-bit values.
# ---------------------------------------------------------------------------

# Define a function to interpolate a raster using geographic nearest neighbors
def interpolate_raster_32bit(**kwargs):
    """
